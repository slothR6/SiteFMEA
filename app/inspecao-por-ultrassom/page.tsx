...
const pageData = getKeywordServicePage("/inspecao-por-ultrassom");
...
export default function InspecaoPorUltrassomPage() {
  return (
    <>
      <JsonLd
        data={[
          createBreadcrumbJsonLd([
            { name: "Início", path: "/" },
            { name: "Inspeção por ultrassom", path: pageData.path }
          ]),
          createServiceJsonLd({
