...
const pageData = getKeywordServicePage("/caracterizacao-de-materiais");
...
export default function CaracterizacaoDeMateriaisPage() {
  return (
    <>
      <JsonLd
        data={[
          createBreadcrumbJsonLd([
            { name: "Início", path: "/" },
            { name: "Caracterização de materiais", path: pageData.path }
          ]),
          createServiceJsonLd({
