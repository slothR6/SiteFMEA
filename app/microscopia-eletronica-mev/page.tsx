...
const pageData = getKeywordServicePage("/microscopia-eletronica-mev");
...
export default function MicroscopiaEletronicaMevPage() {
  return (
    <>
      <JsonLd
        data={[
          createBreadcrumbJsonLd([
            { name: "Início", path: "/" },
            { name: "Microscopia eletrônica MEV", path: pageData.path }
          ]),
          createServiceJsonLd({
