      ...
      <div className="container space-y-10">
        <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
          <div className="space-y-5">
            ...
            <Link href="/responsabilidade-tecnica" className="home-primary-cta">
          ...
          <article className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-[#013d23]/12 bg-white shadow-[0_20px_45px_-45px_rgba(1,61,35,0.9)]">
            ...
            <div className="absolute bottom-0 p-6">
              <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#d5d88e]">Referência em Engenharia</p>
